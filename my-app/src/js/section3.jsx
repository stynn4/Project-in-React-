...
class EventBox extends React.Component {
    ...
    constructor(props) {
        ...
        this.state= {
            classNameApibox: 'col-3 displayApiBox'
    }
    ...
    render(){
        return (
            <div className='col-4'>
                <div className='row'>
                    <div className={this.state.classNameApibox}>apibox1</div>
                    <div className={this.state.classNameApibox}>apibox2</div>
                    <CodeBox clickMethod={this.handleClick} brokenCode={codeStringBroken} fullCode={codeStringFull}/>
                </div>
            </div>   
        )
    }
...
// text for TextTyper
const text = `********************************** 
//dane pobrane przy użyciu metody fetch()// 
********************************** 
//zapytanie wysłane pod adres
https://api.nasa.gov// 
********************************** 
//odpowiedź => obiekt Response w formacie json// 
********************************** 
//kolejna odpowiedź => kolejny obiekt
